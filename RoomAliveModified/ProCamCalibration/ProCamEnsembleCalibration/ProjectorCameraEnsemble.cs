...
namespace RoomAliveToolkit
{
...

    {
        ...
        //this calls CaptureDepthAndColor. Saves gracode.tiff
        ...
        //saves depth data to different format (.bin, .tiff, .ply)
        ...
        //Loads depthData (.bin files)
        //loads decoded graycode (.tiff files)
        //creates a map between depth and decoded graycode (called CallibrationPointSets)
        //writes to pose matrices of camera and projector
        ...
        //As said, it optimizes Camera Pose and Projector pose matrix
